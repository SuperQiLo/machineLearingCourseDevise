...
def main():
    ...
    parser.add_argument("--update-epochs1", type=int, default=4, help="Phase 1 PPO update epochs (A6000 rec: 4)")
    parser.add_argument("--update-epochs2", type=int, default=3, help="Phase 2 PPO update epochs (A6000 rec: 3)")
    parser.add_argument("--minibatch-size1", type=int, default=8192, help="Phase 1 PPO minibatch size (A6000 rec: 8192)")
    parser.add_argument("--minibatch-size2", type=int, default=8192, help="Phase 2 PPO minibatch size (A6000 rec: 8192)")
